...
-- -----------------------------------------------------------------------------------------------------
-- local f = io.open(table.concat({scipm.data.path.scipmchild, "scipm.hex_edit", "scite", "config.lua"}, scipm.data.path.sep), "rb")
-- local configContent = f:read("*all"); -- print(configContent)
-- dostring("scipm.hex_edit.config = " .. configContent);
-- scipm.vardump(scipm.hex_edit.config)
-- f:close()

-- --------------------------------------------------------------------------------------------------------------------------------
-- scipm.hex_edit namespace
-- --------------------------------------------------------------------------------------------------------------------------------
scipm.hex_edit = {}
scipm.hex_edit.config = {};
scipm.hex_edit.data = {}
